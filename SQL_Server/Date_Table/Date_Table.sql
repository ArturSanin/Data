...
IF OBJECT_ID('dbo.DateTable', 'U') IS NOT NULL
	BEGIN
		...
		SELECT 
			Date, -- Column Date
			CAST(TRIM(STR(YEAR(Date))) +  CASE WHEN LEN(TRIM(STR(MONTH(Date)))) = 1 THEN '0' + TRIM(STR(MONTH(Date))) ELSE TRIM(STR(MONTH(Date))) END + CASE WHEN LEN(TRIM(STR(DAY(Date)))) = 1 THEN '0' + TRIM(STR(DAY(Date))) ELSE TRIM(STR(DAY(Date))) END AS INT), -- Column DateAsInteger
			YEAR(Date), -- Column YearNumber
			Month(Date), -- Column MonthAsNumber
			CASE WHEN LEN(TRIM(STR(MONTH(Date)))) = 1 THEN '0' + TRIM(STR(MONTH(Date))) ELSE TRIM(STR(MONTH(Date))) END, -- Column MonthAsNumber
			DAY(Date), -- Column DayAsNumber
			CASE WHEN LEN(TRIM(STR(DAY(Date)))) = 1 THEN '0' + TRIM(STR(DAY(Date))) ELSE TRIM(STR(DAY(Date))) END, -- Column DayAsString
			CASE
			...
			END, -- Column MonthNumberAndNameOfMonth
			CASE
			...
			END, -- Column AS MonthNumberAndNameOfMonthShort
			TRIM(STR(YEAR(Date))) + '-' + CASE WHEN LEN(TRIM(STR(MONTH(Date)))) = 1 THEN '0' + TRIM(STR(MONTH(Date))) ELSE TRIM(STR(MONTH(Date))) END, -- Column YearAndMonthNumber
			CASE
			...
			END, -- Column NameOfMonthShortAndYear
			CASE
			...
			END, -- Column YearAndQuarterOfYear
			CASE
			...
			END, -- Column WeekDayNumber
			DATEPART(WEEK, Date), -- Column WeekOfYear
			'Week ' + TRIM(STR(DATEPART(WEEK, Date))), -- Column WeekOfYearName
			'Wk ' + TRIM(STR(DATEPART(WEEK, Date))), -- Column WeekOfYearNameShort
			TRIM(STR(YEAR(Date))) + ' Week ' + TRIM(STR(DATEPART(WEEK, Date))), -- Column YearAndWeekOfYearName
			CASE
			...
			END, -- Column MonthNameAndWeekOfYearName
			CASE
			...
			END, -- Column MonthNameShortAndWeekOfYearNameShort
			CASE
			...
			END, -- Column YearAndMonthNameAndWeekOfYearName
			CASE
			...
			END, -- Column YearAndMonthNameShortAndWeekOfYearNameShort
			DATEPART(DAYOFYEAR, DATE), -- Column DayYear
			'Day ' + TRIM(STR(DATEPART(DAYOFYEAR, DATE))), -- Column DayOfYearName
			TRIM(STR(YEAR(Date))) + ' Day ' + TRIM(STR(DATEPART(DAYOFYEAR, DATE))), -- Column YearAndDayOfYearName
			TRIM(STR(YEAR(Date))) + ' Week ' + TRIM(STR(DATEPART(WEEK, Date))) + ' Day ' + TRIM(STR(DATEPART(DAYOFYEAR, DATE))), -- Column YearAndWeekOfYearNameAndDayOfYearName
			CASE
			...
			END, -- Column YearAndMonthNameAndWeekOfYearNameAndDayOfYearName
			CASE
			...
			END, -- Column YearAndMonthNameShortAndWeekOfYearNameShortAndDayOfYearName
			CASE
